...
Set the slide to goto supplied item which the _[item]_ is slide index number or jQuery object of the item.
...
Refresh the slide after committed the changes to the slides.
